    ...
    async changeProduct(arg) {
      ...
      this.items = [
        ...
        },
        {
          ...
          col1: "Prix",
          Janvier: (this.product.price * (this.product.seasonalityProduct == null ? 1 : this.product.seasonalityProduct.january)).toFixed(2),
          Février: (this.product.price * (this.product.seasonalityProduct == null ? 1 : this.product.seasonalityProduct.february)).toFixed(2),
          Mars: (this.product.price * (this.product.seasonalityProduct == null ? 1 : this.product.seasonalityProduct.march)).toFixed(2),
          Avril: (this.product.price * (this.product.seasonalityProduct == null ? 1 : this.product.seasonalityProduct.april)).toFixed(2),
          Mai: (this.product.price * (this.product.seasonalityProduct == null ? 1 : this.product.seasonalityProduct.may)).toFixed(2),
          Juin: (this.product.price * (this.product.seasonalityProduct == null ? 1 : this.product.seasonalityProduct.june)).toFixed(2),
          Juillet: (this.product.price * (this.product.seasonalityProduct == null ? 1 : this.product.seasonalityProduct.july)).toFixed(2),
          Août: (this.product.price * (this.product.seasonalityProduct == null ? 1 : this.product.seasonalityProduct.august)).toFixed(2),
          Septembre: (this.product.price * (this.product.seasonalityProduct == null ? 1 : this.product.seasonalityProduct.september)).toFixed(2),
          Octobre: (this.product.price * (this.product.seasonalityProduct == null ? 1 : this.product.seasonalityProduct.october)).toFixed(2),
          Novembre: (this.product.price * (this.product.seasonalityProduct == null ? 1 : this.product.seasonalityProduct.november)).toFixed(2),
          Décembre: (this.product.price * (this.product.seasonalityProduct == null ? 1 : this.product.seasonalityProduct.december)).toFixed(2),
