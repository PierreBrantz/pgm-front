...
/* harmony default export */ __webpack_exports__["a"] = (function (config) {
  return function (selection) {
    var timeScale = config.timeScale,
        onEventClick = config.onEventClick;
    var events = selection.selectAll('g.event').data(selection.data()[0][0]);
    var g = events.enter().append('g').classed('event', true).attr('transform', function (d) {
      return "translate(".concat(timeScale(d.start), " ").concat(d.position * 22, ")");
    }).on('click', onEventClick);
    g.append('rect').attr('width', function (d) {
      return d.end ? timeScale(d.end) - timeScale(d.start) : 10;
    }).attr('height', 20).attr('fill', 'rgba(85, 187, 238, 0.2)').attr('ry', 6);
    g.append('text').attr('dy', '1em').style('pointer-events', 'none').text(function (d) {
      return d.name;
    });
    events.attr('transform', function (d) {
      return "translate(".concat(timeScale(d.start), " ").concat(d.position * 22, ")");
    }).selectAll('rect').attr('width', function (d) {
      return d.end ? timeScale(d.end) - timeScale(d.start) : 10;
    }); // events
    //     .exit()
    //     .on('click', null)
...
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("5698");
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("1f8e");
/* harmony import */ var _axis__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("611f");
/* harmony import */ var _zoom__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("5157");
/* harmony import */ var _cursor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("9424");
/* harmony import */ var _layout__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("cf16");
...
/* harmony default export */ __webpack_exports__["a"] = (function (config) {
  function init(selection) {
    ...
    var events = data[0];
    _layout__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"].generate(events);
    console.table(events);
    var _config$viewWidth = config.viewWidth,
        viewWidth = _config$viewWidth === void 0 ? 800 : _config$viewWidth,
        _config$viewHeight = config.viewHeight,
        viewHeight = _config$viewHeight === void 0 ? 200 : _config$viewHeight,
        _config$widthResizabl = config.widthResizable,
        widthResizable = _config$widthResizabl === void 0 ? true : _config$widthResizabl,
        margin = config.margin,
        onEventClick = config.onEventClick,
        _config$showCursor = config.showCursor,
        showCursor = _config$showCursor === void 0 ? true : _config$showCursor;

    if (widthResizable) {
      viewWidth = selection.node().clientWidth;
    }

    var width = viewWidth - margin.right - margin.left;
    var height = viewHeight - margin.top - margin.bottom;
    var svg = selection.append('svg').datum(data).attr('width', width + margin.right + margin.left).attr('height', height + margin.top + margin.bottom);
    var timeScale = d3__WEBPACK_IMPORTED_MODULE_2__[/* scaleTime */ "e"]().domain([d3__WEBPACK_IMPORTED_MODULE_2__[/* min */ "d"](events.map(function (e) {
      return e.start;
    })), d3__WEBPACK_IMPORTED_MODULE_2__[/* max */ "c"](events.map(function (e) {
      return e.end;
    }))]).range([0, width]);
    var graph = svg.append('g').classed('graph', true).attr('transform', "translate(".concat(margin.left, ",").concat(margin.top, ")"));
    var view = graph.append('g').classed('view', true);
    svg.call(Object(_zoom__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])({
      timeScale: timeScale,
      view: view,
      draw: draw
    }));
  ...
  function draw(timeScale, onEventClick, height, showCursor) {
    return function (selection) {
      selection.data(selection.data()).call(Object(_events__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])({
        timeScale: timeScale,
        onEventClick: onEventClick
      })).call(Object(_axis__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])({
        timeScale: timeScale,
        height: height
      })).call(Object(_cursor__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])({
...
"use strict";
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("5698");

/* harmony default export */ __webpack_exports__["a"] = (function (config) {
  var timeScale = config.timeScale,
      view = config.view,
      draw = config.draw;
  return d3__WEBPACK_IMPORTED_MODULE_0__[/* zoom */ "k"]() //.translateExtent([[ -1200, -700 ], [ 800, 800 ]])
  .on('zoom', function () {
    var _d3$event$transform = d3__WEBPACK_IMPORTED_MODULE_0__[/* event */ "b"].transform,
        k = _d3$event$transform.k,
        x = _d3$event$transform.x,
        y = _d3$event$transform.y;
    var scale = d3__WEBPACK_IMPORTED_MODULE_0__[/* zoomIdentity */ "l"].translate(x, y).scale(k).rescaleX(timeScale);
...
function format(date) {
  if (d3__WEBPACK_IMPORTED_MODULE_0__[/* timeDay */ "g"](date) < date) {
    return d3__WEBPACK_IMPORTED_MODULE_0__[/* timeFormat */ "h"]('%I:%M')(date);
  }

  if (d3__WEBPACK_IMPORTED_MODULE_0__[/* timeMonth */ "i"](date) < date) {
    return d3__WEBPACK_IMPORTED_MODULE_0__[/* timeFormat */ "h"]('%b %d')(date);
  }

  if (d3__WEBPACK_IMPORTED_MODULE_0__[/* timeYear */ "j"](date) < date) {
    return d3__WEBPACK_IMPORTED_MODULE_0__[/* timeFormat */ "h"]('%B')(date);
  }

  return d3__WEBPACK_IMPORTED_MODULE_0__[/* timeFormat */ "h"]('%Y')(date);
}
...
/* harmony default export */ __webpack_exports__["a"] = (function (config) {
  return function (selection) {
    ...
    var axe = selection.selectAll('.axe').data(function (d) {
      return d;
    });
    var ay = d3__WEBPACK_IMPORTED_MODULE_0__[/* axisBottom */ "a"]().scale(timeScale).tickFormat(function (d) {
      return format(d);
    });
    axe.enter().append('g').attr('transform', "translate(0, ".concat(height + 5, ")")).classed('axe', true).call(ay);
    axe.call(ay);
  };
});
...
/* harmony default export */ __webpack_exports__["a"] = (function (config) {
  return function (selection) {
    var timeScale = config.timeScale,
        height = config.height; // if (!showCursor) return //issue with zoom

    var now = timeScale(Date.now());
    var cursor = selection.selectAll('.cursor').data(function (d) {
      return d;
    });
    var g = cursor.enter().append('g').classed('cursor', true).attr('transform', "translate(".concat(now, ")"));
    g.append('line').attr('x1', 0).attr('y1', 0).attr('x2', 0).attr('y2', height).attr('stroke', 'red');
    cursor.attr('transform', "translate(".concat(now, ")"));
  };
});
...
/* harmony default export */ __webpack_exports__["a"] = ({
  generate: function generate(data) {
    ...
    var maxLevel = 11;
    data.forEach(function (e) {
      return e.position = maxLevel - e.level;
    });
  }
});
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"1c1982de-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/VueTimeline.vue?vue&type=template&id=afbb8714&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"timeline"}})}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/VueTimeline.vue?vue&type=template&id=afbb8714&

// EXTERNAL MODULE: ./node_modules/d3/index.js + 284 modules
var d3 = __webpack_require__("5698");

// EXTERNAL MODULE: ./src/graph/timeline.js
var timeline = __webpack_require__("2d46");

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/VueTimeline.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var VueTimelinevue_type_script_lang_js_ = ({
  props: {
    data: {
      type: Array
    }
  ...
  mounted: function mounted() {
    d3["f" /* select */]('#timeline').datum(this.data).call(Object(timeline["a" /* default */])({
      widthResizable: true,
      viewHeight: 300,
      margin: {
        top: 0,
...
// CONCATENATED MODULE: ./src/components/VueTimeline.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_VueTimelinevue_type_script_lang_js_ = (VueTimelinevue_type_script_lang_js_); 
...
var component = normalizeComponent(
  components_VueTimelinevue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var VueTimeline = (component.exports);
// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (VueTimeline);
...
/******/ })["default"];
//# sourceMappingURL=vue-timeline-component.common.js.map